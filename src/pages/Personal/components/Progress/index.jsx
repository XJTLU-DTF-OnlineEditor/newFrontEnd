          ...
          <ProCard
            ...
            extra={
              <Progress
                ...
                percent={100 * parseInt(item.progress.substr(0, 1)) / parseInt(item.progress.substr(2, 1))}
                width={50}/>
            }>
            <ProCard colSpan="20%" ghost>
              ...
              <center>
                <div>
                  last practice time: {item.last_practice_time.substr(0,10)}
                </div>
                <div>
                  <Button
                    style={{marginTop: "5%"}}
              ...
              <ProCard ghost split="horizontal">
                ...
                <ProCard split="vertical">
                  ...
                  <ProCard>
                    ...
                    {finished_course.length === 0 && (
                      <div>continue to work on present aims!</div>
                    )}
                  </ProCard>
                  <ProCard>
                    <List
